...
def load_ciphers():
    ciphers = set()
    with open('C:\\Users\\seren\\OneDrive\\Documents\\vscode\\Cryptohack\\Symmetric_ciphers\\Stream_ciphers\\ciphers.txt', 'rb') as fd:
        while True:
...
## attempts to break stream cipher by manually 
# analyzing and guesssing key
# using cryptohack web service to encrypt using response.json
# finding prefix 'crypto{'