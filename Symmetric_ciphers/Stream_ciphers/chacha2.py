...
## implements basic ChaCha20 stream cipher 
# performing chacha20 to get output chacha20 stream
# as well as output decryption
# this code was given by cryptohack challenges and modified 