...
## this brute force the crypt flag using the encryption function
# from the web service and using respnse.json 'ciphertext'
# if the decrypt flag contains prefix 'crypto{' and suffix '}'
# print that