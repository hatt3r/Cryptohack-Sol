...
## performs AES decryption and XOR operations to print the message
# during the first one it stops at 3gr4m} 
# creating for remaining ones it stops at 'crypto{h3ll0_t3l' 
# we put it together to get the flag