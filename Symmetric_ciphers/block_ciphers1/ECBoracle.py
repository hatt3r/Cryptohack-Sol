...
##using web service to get the cookie
# convert cookie to get iv
# use iv and cookie to get response for admin
#use xor operations and checking again for admin to flag value