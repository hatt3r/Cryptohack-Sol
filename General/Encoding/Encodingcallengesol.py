...
##communicates with a remote server to solve encoding challenges. 
# It connects to socket.cryptohack.org on port 13377 and processes up to 101 cycles of challenges. 
# For each challenge, it receives encoded data, determines the encoding type it could be rot13,utf8,base64 or hex 
# and decodes it,
# and sends the decoded value back to the server. 
# If the server provides a flag, it prints it and terminates the loop. 