...
##elliptic curve Diffie-Hellman key exchange to output a shared secret, 
# we output alice key and bob key then use it to encrypt the flag
# which is then used to encrypt a flag using AES in CBC mode.